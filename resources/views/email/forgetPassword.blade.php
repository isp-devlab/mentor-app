				...
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 40px; text-align:center;">
							<a href="{{ route('reset', $token) }}" rel="noopener" style="text-decoration:none;display:inline-block;text-align:center;padding:0.75575rem 1.3rem;font-size:0.925rem;line-height:1.5;border-radius:0.35rem;color:#ffffff;background-color:#000C32;border:0px;margin-right:0.75rem!important;font-weight:600!important;outline:none!important;vertical-align:middle" target="_blank">Reset Password</a>
						</div>
						...
						<div style="padding-bottom: 10px; word-wrap: break-all;">
							...
							<a href="{{ route('reset', $token) }}" rel="noopener" target="_blank" style="text-decoration:none;color: #04C8C8">{{ route('reset', $token) }}</a>
						</div>
						<!--end:Email content-->
						<div style="padding-bottom: 10px">Salam hangat
						<br>Informatics Study Platform.
						<tr>
							<td align="center" valign="center" style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
								<p>Kampus Utama Bukit Indah,<br>
									Muara Satu, Kota Lhokseumawe,<br>
									Provinsi Aceh, Indonesia</p>
								<p>Copyright ©
								<a href="https://github.com/isp-devlab" rel="noopener" target="_blank">ISP DEV LAB</a>.</p>
							</td>
						</tr></br></div>
					</div>
				</td>
