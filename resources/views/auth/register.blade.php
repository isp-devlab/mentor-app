...
<form class="form w-100" id="register" method="POST" action="{{ route('register.submit') }}">
  @csrf
  ...
  <div class="text-center">
      <button type="button" id="submitButton" class="btn btn-primary btn-lg w-100 mb-5" onclick="disableButton('register')">
        Register
      </button>
