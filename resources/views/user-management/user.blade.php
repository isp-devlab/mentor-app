  ...
  <div class="row g-6 g-xl-9">
    <div class="card">
      <div class="card-header border-0 py-6 d-flex align-content-center">
        <h2 class="fw-bold card-title">User</h2>
        <form method="GET" action="{{ route('user-management.user') }}">
          ...
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <input type="text"  class="form-control form-control-solid w-250px ps-14" name="q" value="{{ request('q') }}" placeholder="Search User" />
          </div>
        </form>
      </div>
                ...
                <tr>
                  ...
                  <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-3" data-kt-menu="true">
                      ...
                      <div class="menu-item px-3">
                        <a href="#" id="{{ route('user-management.user.destroy', $item->id) }}" class="menu-link btn-del px-3">Delete</a>
                      </div>
                    </div>
                  </td>
                </tr>
                  ...
                  <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content">
                      ...
                      <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <form  class="form" action="{{ route('user-management.user.update', $item->id) }}" method="POST">
                          @csrf
